...
public class PainelMidiasSociaisCitacoes extends javax.swing.JPanel {

    DaoOpiniao dop = new DaoOpiniao();
    PainelCitacao[] citacoes = new PainelCitacao[12];

    public PainelMidiasSociaisCitacoes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mídias Sociais - Opniões recentes");
    ...
    public void atualizarCitacoes() {
        ...
        CachedRowSet resultado = (dop.atualizarCitacoes(cbbFontes.getSelectedItem().toString()));
