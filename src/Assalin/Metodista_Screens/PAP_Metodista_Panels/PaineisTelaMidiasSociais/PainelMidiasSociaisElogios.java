...
public class PainelMidiasSociaisElogios extends javax.swing.JPanel {

    DaoOpiniao dop = new DaoOpiniao();
    PainelCitacao[] citacoes = new PainelCitacao[12];

    public PainelMidiasSociaisElogios() {
        initComponents();
    ...
    public void atualizarCitacoes() {
        ...
        CachedRowSet resultado = (dop.atualizarElogios(cbbFontes.getSelectedItem().toString()));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mídias Sociais - Elogios recentes");
